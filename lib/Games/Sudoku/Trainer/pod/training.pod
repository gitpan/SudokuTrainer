...
successful strategy. A  on the I<Run> button terminates the pause.

=item * Priorities

Here you may adapt the priority list to your preferences by moving a selected 
strategy up or down. You may also return to the default priority list.
...
help. If you succeed - congratulations! If you don't, you may  the
